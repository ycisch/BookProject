...
<div class="father">
    ...
    <div class="left">
        ...
        <div class="left_list">
            <ul>
                <li><a href="${pageContext.request.contextPath}/user/personalInfo.jsp" target="mainframe">查看个人信息</a> </li>

                <li><a href="${pageContext.request.contextPath}/user/shopCart.jsp" target="mainframe">我的购物车</a></li>

                <li><a href="${pageContext.request.contextPath}/user/order.jsp" target="mainframe">我的订单</a></li>
            </ul>
        </div>
    </div>
    <div class="right">
